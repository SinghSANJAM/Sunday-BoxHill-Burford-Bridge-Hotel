document.addEventListener('DOMContentLoaded', () => {
    ...
    const roomDetails = {
      'Tithe Barn Suite': {
        details: 'The historic Tithe Barn Suite, with its striking wooden beams and private entrance, is perfect for grand wedding receptions or ceremonies, accommodating up to 180 guests in a banquet or theatre setup.'
      },
      'Garden Room': {
      ...
      'Burford Room': {
        details: 'A versatile space adjacent to the River Room, suitable for large weddings or receptions up to 180 guests, with air conditioning and integrated AV.'
      },
      'River Room': {
        details: 'A cozy space for smaller ceremonies or receptions up to 50 guests, featuring air conditioning and scenic views.'
      }
    };
